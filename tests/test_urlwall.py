...
class TestGetCanonicalHost(unittest.TestCase):
    def test_simple(self):
        self.assertEqual(urlwall.getCanonicalHost('https://example.com/path'), 'example.com')

    def test_www(self):
        self.assertEqual(urlwall.getCanonicalHost('https://www.example.com'), 'example.com')
...
class TestNiceHost(unittest.TestCase):
    ...
    def test_safelinks(self):
        self.assertEqual(
            urlwall.niceHost('https://outlook.com/redirect?url=xxx'),
            'outlook.com'
        )
...
class TestIsUrlAllowed(unittest.TestCase):
    ...
    def test_unwraps_url_query(self):
        ...
        self.assertTrue(urlwall.isUrlAllowed('https://redirect.com/?url=https://target.com'))
